	...
	<section class="rad">
		<div>
			<ul>
				...
				<li><span><i class="far fa-square"></i></span>na otvorenom </li>
		...
		<div>
			<ul>
				...
				<li><span><i class="far fa-square"></i></span>terenski rad</li>
				<li><span><i class="far fa-check-square"></i></span>radi sam</li>
				<li><span><i class="far fa-square"></i></span>radi s grupom</li>
		...
		<div>
			<ul>
				...
				<li><span><i class="far fa-square"></i></span>rad stojeći</li>
