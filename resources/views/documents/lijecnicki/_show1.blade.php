...
<div class="container">
	...
	<div class="row">
		...
		<div id="padding4">
		1) Poslovi  su prema članku ____3.____ točka __{{ $employee->tocke  }}._ Pravilnika o poslovima s posebnim uvjetima rada.
		</div>
		<div id="padding4">
		...
		<div id="padding4">
		Predmet rada<sup>2</sup>: _____________________________________________________________________________________
		</div>
		<div id="padding4">
		Mjesto rada:
