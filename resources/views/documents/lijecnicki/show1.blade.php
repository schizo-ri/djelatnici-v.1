...
<body>
	...
	<section>
		...
		<ul>
			<li>2) Poslovi prema drugim zakonima, propisima ili kolektivnom ugovoru:</li>
			<li class="box"></li>
		</ul>
		<ul>
			<li class="box"></li>
			<li> se utvrđuje zdravstvena sposobnost radnika.</li>
		</ul>
		...
		<p class="box5"></p>
		<p class="napomene1">(navesti zakon, propis ili kolektivni ugovor iz članka 2. stavka 1. podstavka 2. ili 3. Pravilnika)</p>
	...
	<section class="rad">
		<div>
			<ul>
				...
				<li><span><i class="far fa-check-square"></i></span>na visini</li>
				<li><span><i class="far fa-check-square"></i></span>u jami</li>
		...
		<div>
			<ul>
				...
				<li><span><i class="far fa-square"></i></span>radi sa strankama</li>
			</ul>
		</div>
		<div>
			<ul>
		...
		<div>
			<ul>
				...
				<li><span><i class="far fa-square"></i></span>rad sjedeći</li>
		...
		<div>
			<ul>
				...
				<li><span><i class="far fa-square"></i></span>u pokretu</li>
