...
class EmployeeController extends Controller
{
   ...
   */
	...
	$employee = Employee::join('works','employees.radnoMjesto_id', '=', 'works.id')->select('employees.*','works.odjel','works.naziv')->where('employees.id',$employee1->id)->first();
	...
	return view('documents.lijecnicki.show', ['employee' => $employee]);
	}
}
